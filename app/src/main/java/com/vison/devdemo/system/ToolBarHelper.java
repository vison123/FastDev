...
/*上下文，创建view的时候需要用到*/
    ...
    * */
    ...
    private void initUserView(int id) {
        ...
        /*获取主题中定义的toolbar的高度*/
        int toolBarSize = (int) typedArray.getDimension(1, (int) mContext.getResources().getDimension(R.dimen.activity_toolbar_height));

        typedArray.recycle(); /*如果是悬浮状态，则不需要设置间距*/
        params.topMargin = overly ? 0 : toolBarSize - 20;
